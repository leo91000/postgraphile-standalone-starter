...
export default async function user_emails__send_verification(rawPayload: unknown, { addJob, withPgClient }: JobHelpers): Promise<void> {
  const payload: UserEmailsSendVerificationPayload = rawPayload as any
