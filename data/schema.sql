...
GRANT USAGE ON SCHEMA app_hidden TO anais_coletta_coaching_visitor;
...
GRANT USAGE ON SCHEMA app_public TO anais_coletta_coaching_visitor;
...
GRANT ALL ON SCHEMA public TO anais_coletta_coaching;
GRANT USAGE ON SCHEMA public TO anais_coletta_coaching_visitor;
...
GRANT SELECT ON TABLE app_public.users TO anais_coletta_coaching_visitor;
...
GRANT UPDATE(username) ON TABLE app_public.users TO anais_coletta_coaching_visitor;
...
GRANT UPDATE(name) ON TABLE app_public.users TO anais_coletta_coaching_visitor;
...
GRANT UPDATE(avatar_url) ON TABLE app_public.users TO anais_coletta_coaching_visitor;
...
GRANT ALL ON FUNCTION app_public.change_password(old_password text, new_password text) TO anais_coletta_coaching_visitor;
...
GRANT ALL ON FUNCTION app_public.confirm_account_deletion(token text) TO anais_coletta_coaching_visitor;
...
GRANT ALL ON FUNCTION app_public.current_session_id() TO anais_coletta_coaching_visitor;
...
GRANT ALL ON FUNCTION app_public."current_user"() TO anais_coletta_coaching_visitor;
...
GRANT ALL ON FUNCTION app_public.current_user_id() TO anais_coletta_coaching_visitor;
...
GRANT ALL ON FUNCTION app_public.forgot_password(email public.citext) TO anais_coletta_coaching_visitor;
...
GRANT ALL ON FUNCTION app_public.logout() TO anais_coletta_coaching_visitor;
...
GRANT SELECT,DELETE ON TABLE app_public.user_emails TO anais_coletta_coaching_visitor;
...
GRANT INSERT(email) ON TABLE app_public.user_emails TO anais_coletta_coaching_visitor;
...
GRANT ALL ON FUNCTION app_public.make_email_primary(email_id uuid) TO anais_coletta_coaching_visitor;
...
GRANT ALL ON FUNCTION app_public.request_account_deletion() TO anais_coletta_coaching_visitor;
...
GRANT ALL ON FUNCTION app_public.resend_email_verification_code(email_id uuid) TO anais_coletta_coaching_visitor;
...
GRANT ALL ON FUNCTION app_public.tg__graphql_subscription() TO anais_coletta_coaching_visitor;
...
GRANT ALL ON FUNCTION app_public.tg_user_emails__forbid_if_verified() TO anais_coletta_coaching_visitor;
...
GRANT ALL ON FUNCTION app_public.tg_user_emails__prevent_delete_last_email() TO anais_coletta_coaching_visitor;
...
GRANT ALL ON FUNCTION app_public.tg_user_emails__verify_account_on_verified() TO anais_coletta_coaching_visitor;
...
GRANT ALL ON FUNCTION app_public.users_has_password(u app_public.users) TO anais_coletta_coaching_visitor;
...
GRANT ALL ON FUNCTION app_public.verify_email(user_email_id uuid, token text) TO anais_coletta_coaching_visitor;
...
GRANT SELECT,DELETE ON TABLE app_public.user_authentications TO anais_coletta_coaching_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE anais_coletta_coaching IN SCHEMA app_hidden GRANT SELECT,USAGE ON SEQUENCES  TO anais_coletta_coaching_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE anais_coletta_coaching IN SCHEMA app_hidden GRANT ALL ON FUNCTIONS  TO anais_coletta_coaching_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE anais_coletta_coaching IN SCHEMA app_public GRANT SELECT,USAGE ON SEQUENCES  TO anais_coletta_coaching_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE anais_coletta_coaching IN SCHEMA app_public GRANT ALL ON FUNCTIONS  TO anais_coletta_coaching_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE anais_coletta_coaching IN SCHEMA public GRANT SELECT,USAGE ON SEQUENCES  TO anais_coletta_coaching_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE anais_coletta_coaching IN SCHEMA public GRANT ALL ON FUNCTIONS  TO anais_coletta_coaching_visitor;
...
ALTER DEFAULT PRIVILEGES FOR ROLE anais_coletta_coaching REVOKE ALL ON FUNCTIONS  FROM PUBLIC;
